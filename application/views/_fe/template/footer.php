                ...
                <div class="col-lg-3 col-md-6 col-12">
                    ...
                    <div class="site-footer-thumb mb-4 pb-2">
                        <div class="d-flex flex-wrap">
                            <a href="#">
                                <img src="<?= base_url('assets/podtalk/') ?>images/app-store.png" class="me-3 mb-2 mb-lg-0 img-fluid" alt="">
                            </a>

                            <a href="#">
                                <img src="<?= base_url('assets/podtalk/') ?>images/play-store.png" class="img-fluid" alt="">
                            </a>
                        </div>
                    </div>
